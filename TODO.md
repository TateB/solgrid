...
- [ ] Extend semantic/interprocedural detector depth beyond the shipped same-file, inherited-helper, uniquely resolved contract-typed helper-wrapper propagation, and arity-disambiguated imported wrapper overloads, especially across arbitrary cross-file call edges and same-arity overload-heavy flows
