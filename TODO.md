...
- [ ] Deepen the shipped semantic-token surface beyond the current full/delta/range declarations, readonly markings, and high-signal references, especially for more ambiguous cross-file and member-heavy cases that still need stronger kind/metadata preservation
