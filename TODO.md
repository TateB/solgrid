...
- [ ] Extend semantic/interprocedural detector depth beyond the shipped same-file, inherited-helper, and uniquely resolved contract-typed helper-wrapper propagation, including member, indexed, and getter-returned helper bases, especially across arbitrary cross-file call edges and overload-heavy flows
