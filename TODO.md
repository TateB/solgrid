...
- [ ] Extend semantic/interprocedural detector depth beyond the shipped same-file, inherited-helper, transitive imported-wrapper-chain, contract-typed helper-wrapper propagation through uniquely resolved member/indexed bases and collapsed helper-returning call targets, and propagated-result-disambiguated imported wrapper overloads, especially across arbitrary non-unique cross-file call graphs, conflicting overload summaries, and non-unique wrapper graphs
