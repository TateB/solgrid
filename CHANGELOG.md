...
- Fixed `style/category-headers` suggestion fixes to preserve categories omitted from custom `order` lists, and restored validated config support for `naming/func-name-mixedcase` exceptions
